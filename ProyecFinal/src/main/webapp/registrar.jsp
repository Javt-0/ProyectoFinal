<%-- 
    Document   : registrar
    Created on : 21 feb. 2023, 21:04:42
    Author     : jonat
--%>
            ...
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form  method="POST" action="UsuarioControlador?accion=registrar" enctype="multipart/form-data">
                    <!--Primer campo-->
                    <div class="mb-3 row">
                    ...
                    <!--Primer campo-->
                    <div class="mb-3 row">
                      <label class="col-md-4 col-form-label text-md-end">Apellidos</label>
                      <div class="col-md-6">
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-md-6">
                        <input type="date" name="fechaNac" class="form-control" autofocus>
                        <!--input type="text" name="usuario" class="form-control" autofocus-->
                      </div>
                    </div>
                    ...
                    <!--Tercer campo-->
                    <div class="mb-3 row">
                      <label class="col-md-4 col-form-label text-md-end">Pais</label>
                      <div class="col-md-6">
                        <input type="text" name="pais" class="form-control" autofocus>
                        <!--input type="text" name="usuario" class="form-control" autofocus-->
                      </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-md-6">
                        <input type="text" name="nomUsu" class="form-control" autofocus>
                        <!--input type="text" name="usuario" class="form-control" autofocus-->
                      </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        <label for="portada"  class="col-md-4 col-form-label text-md-end">Imagen de perfil</label>

                        <div class="col-md-6">
                          <input  type="file" class="form-control" name="imgPerfil" required autocomplete="imgPerfil" autofocus>
                        </div>
                      </div>
                    <div class="mb-3 row">
                    ...
                    <div class="row">
                      <div class="col-md-6 offset-md-4">
                        <p class="text-light">
                          ¿Ya tienes una cuenta? <a class="text-primary" href="./registrar.jsp">Inicia sesion</a>
                        </p>
                      </div>
                    </div>
